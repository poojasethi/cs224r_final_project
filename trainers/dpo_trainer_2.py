...
class DPOTrainer:   # NOTE: Copied from Pooja's sft_trainer
    ...
    def dpo_loss(
        ...
        # DPO loss formula
        # L_DPO = - log(sigmoid(beta * (log_ratio_preferred - log_ratio_dispreferred)))
        loss = -F.logsigmoid(beta * (log_ratio_preferred - log_ratio_dispreferred)).mean()
        ...
        for epoch in range(self.args.epochs):
            ...
            for step, batch in enumerate(progress_bar):
                ...
                with self.accelerator.accumulate(self.model):
                    ...
                    # 3. Clip gradients and step the optimizer.
    ...
    def evaluate(self):
        ...
        for batch in tqdm(self.eval_dataloader, desc="Evaluating", disable=not self.accelerator.is_main_process):
            # No need to manually move to device, Accelerator handles it
