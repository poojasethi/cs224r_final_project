...
INITIAL_RESULTS_PATH = "evaluation/input/marielle_test_dpo_model_25-06-09-030935_25000.json"
OUTPUT_ITERATIVE_RESULTS_PATH = "evaluation/output/dpo/marielle_test_long.json" # Detailed results
OUTPUT_FINAL_RESPONSES_PATH = "evaluation/output/dpo/marielle_test_short.json" # New file for just prompt and final response
...
if __name__ == "__main__":
    ...
    # Initialize ChatGPT4o-mini
    teacher_client = OpenAI(api_key=TEACHER_MODEL_API_KEY)

    # Initialize to record responses
    ...
    for step, (prompt, response) in enumerate(progress_bar):
        ...
        # Decide whether to use the teacher model's response instead
